...
@Profile("!test")
public class XtrimlogySecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    AuthenticationProvider authenticationProvider() {
        ...
        XtrimlogyUserDetailsService detailsService = new XtrimlogyUserDetailsService(userEntityRepository, config);
